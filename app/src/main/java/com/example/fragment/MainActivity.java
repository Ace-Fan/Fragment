...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fg_content1);
        ...
        imge1=(ImageView) findViewById(R.id.img3);
        imge1.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick(View v) {
                // TODO 自动生成的方法存根
                Intent it=new Intent(MainActivity.this,Denglu.class);
                startActivity(it);
            }
        });

        imge2=(ImageView)findViewById(R.id.img2);
        imge2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent itr=new Intent(MainActivity.this,XinWenMainActivity.class);
                startActivity(itr);
            }
        });

        imge3=(ImageView)findViewById(R.id.img5);
        imge3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent its=new Intent(MainActivity.this,JiaZhengMainActivity.class);
                startActivity(its);
            }
        });
    }
    ...
    private View.OnClickListener onBannerClickListener=new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            Toast.makeText(MainActivity.this,"重要消息:"+position,Toast.LENGTH_LONG).show();
        }
    };
