...
public class MovieRatingDataHelper extends SQLiteOpenHelper{
    ...
    private static final String INSERT = "insert into "
            + TABLE_NAME + "(name, phone ,password ,age ,sex) values (?,?,?,?,?)";

    //构造函数
    public MovieRatingDataHelper(Context context, String name, SQLiteDatabase.CursorFactory cursorFactory,int version) {
    ...
    //增加一条记录的方法
    public long insert(String name, String phone, String password, String age,
                       String sex) {
        //设置SQL语句中？的值，从1开始，依次绑定
        this.insertStmt.bindString(1, name);
        this.insertStmt.bindString(2, phone);
        this.insertStmt.bindString(3, password);
        this.insertStmt.bindString(4, age);
        this.insertStmt.bindString(5, sex);
    ...
    public List<String> selectById(int id) {
        ...
        Cursor cursor = this.db.query(TABLE_NAME, new String[] {"name", "phone", "password", "age", "sex"},
    ...
    private static class OpenHelper extends SQLiteOpenHelper {
       ...
       OpenHelper(Context context) {
        ...
        public void onCreate(SQLiteDatabase db) {
            //创建表
            db.execSQL("CREATE TABLE " + TABLE_NAME + "(id INTEGER PRIMARY KEY, name TEXT, phone TEXT, password TEXT, age TEXT, sex TEXT)");
        }
        //更新数据库
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
